...
class StoreTripRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'initial_longitude' => 'nullable|numeric|between:25.237,33.056',
            'initial_latitude' => 'nullable|numeric|between:-22.421,-15.609',
            'initial_altitude' => 'nullable|numeric|min:0|max:2000',
