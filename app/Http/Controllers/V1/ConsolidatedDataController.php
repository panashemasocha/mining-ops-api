...
class ConsolidatedDataController extends Controller
{
    ...
    public function getConsolidatedData(GetConsolidatedDataRequest $request)
    {
        ...
        if ($roleId == 3 && $jobPositionId == 7) {
            ...
            $data['oreType'] =  ['data' => OreTypeResource::collection($this->oreTypeRepository->getOreTypes())];
            $data['oreQualityType'] =  ['data' => OreQualityTypeResource::collection($this->oreQualityTypeRepository->getAllOreQualityTypes())];
            $data['oreQualityGrade'] =  ['data' => OreQualityGradeResource::collection($this->oreQualityGradeRepository->getAllOreQualityGrade())];
